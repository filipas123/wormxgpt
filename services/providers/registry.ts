...
export const EXPANDED_PROVIDERS: Record<string, ProviderConfig> = {
  ...
  deepinfra: {
    ...
    authHeader: (key) => ({ Authorization: `Bearer ${key}` }),
    models: ['deepseek-ai/DeepSeek-V4-Pro', 'deepseek-ai/DeepSeek-V4-Flash-0731', 'deepseek-ai/DeepSeek-V3.2', 'moonshotai/Kimi-K3', 'zai-org/GLM-5.3', 'Qwen/Qwen3.8-Max', 'meta-llama/Llama-4-Scout-17B-16E-Instruct', 'meta-llama/Llama-3.3-70B-Instruct'],
  ...
  llm7: { id: 'llm7', name: 'LLM7 Gateway (Free & Fast)', baseUrl: 'https://api.llm7.io/v1', authHeader: (k) => ({ Authorization: `Bearer ${k}` }), models: ['gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-5.5', 'claude-sonnet-5', 'claude-haiku-4-5', 'claude-opus-4-8', 'gemini-3-flash', 'gemini-3.7-flash', 'grok-4.6', 'grok-4.5', 'kimi-k3', 'glm-5.3', 'glm-5.3-flash', 'deepseek-v4-pro', 'deepseek-v4-flash:0731', 'minimax-m2.7', 'codestral-latest', 'llama-4-maverick', 'Inkling'], category: 'router' },
  nanogpt: { id: 'nanogpt', name: 'NanoGPT (600+ Model Gateway)', baseUrl: 'https://nano-gpt.com/api/v1', authHeader: (k) => ({ Authorization: `Bearer ${k}` }), models: ['openai/gpt-5.6-luna', 'openai/gpt-5.5', 'anthropic/claude-sonnet-5', 'anthropic/claude-opus-4.8', 'x-ai/grok-4.6', 'z-ai/glm-5.3', 'deepseek/deepseek-v4-pro', 'deepseek/deepseek-v4-flash', 'moonshotai/kimi-k3', 'moonshotai/kimi-k2.5', 'minimax/minimax-m2.7', 'qwen/qwen3.8-27b', 'meta-llama/llama-4-maverick', 'google/gemma-4-31b-it', 'z-ai/glm-5.3-flash-uncensored', 'TheDrummer/Artemis-v1.1'], category: 'router' },
  ovh: { id: 'ovh', name: 'OVHcloud AI Endpoints (Sovereign EU)', baseUrl: 'https://oai.endpoints.kepler.ai.cloud.ovh.net/v1', authHeader: (k) => ({ Authorization: `Bearer ${k}` }), models: ['Qwen3.8-27B', 'Qwen3.6-27B', 'Qwen3.5-397B-A17B', 'Qwen3.5-9B', 'Qwen3-Coder-30B-A3B-Instruct', 'Qwen3-32B', 'Meta-Llama-3_3-70B-Instruct', 'gpt-oss-120b', 'gpt-oss-20b', 'Mistral-Small-3.2-24B-Instruct-2506', 'Mistral-Nemo-Instruct-2407', 'Mistral-7B-Instruct-v0.3'], category: 'router' },
...
export const openrouterProvider: IModelProvider = {
  id: 'openrouter',
  name: 'OpenRouter (Unified Gateway)',
  description: 'Unified multi-model aggregator with access to 400+ models (GPT-5.6, Claude 5, Gemini 3.8, Grok 4.6, Kimi K3 + free tier)',
  requiresApiKey: true,
  apiKeyField: 'openRouterApiKey',
  docsUrl: 'https://openrouter.ai/keys',
  models: [
    { id: 'openai/gpt-5.6-sol', label: 'GPT-5.6 Sol (OpenAI Flagship)', contextWindow: 400000, tags: ['reasoning', 'code', 'vision'] },
    { id: 'openai/gpt-5.6-luna', label: 'GPT-5.6 Luna (Fast)', contextWindow: 200000, tags: ['fast', 'code'] },
    { id: 'openai/gpt-5.5', label: 'GPT-5.5', contextWindow: 400000, tags: ['reasoning', 'code'] },
    { id: 'anthropic/claude-opus-5', label: 'Claude Opus 5 (Most Intelligent)', contextWindow: 200000, tags: ['reasoning', 'code', 'vision'] },
    { id: 'anthropic/claude-sonnet-5', label: 'Claude Sonnet 5', contextWindow: 200000, tags: ['reasoning', 'code', 'vision'] },
    { id: 'anthropic/claude-opus-4.8', label: 'Claude Opus 4.8', contextWindow: 200000, tags: ['reasoning', 'code'] },
    { id: 'anthropic/claude-sonnet-4.5', label: 'Claude Sonnet 4.5', contextWindow: 200000, tags: ['reasoning', 'code'] },
    { id: 'google/gemini-2.5-pro', label: 'Gemini 2.5 Pro', contextWindow: 1000000, tags: ['reasoning', 'vision'] },
    { id: 'google/gemini-2.5-flash', label: 'Gemini 2.5 Flash', contextWindow: 1000000, tags: ['fast', 'vision'] },
    { id: 'google/gemini-3.8-flash', label: 'Gemini 3.8 Flash', contextWindow: 1000000, tags: ['fast', 'vision', 'reasoning'] },
    { id: 'x-ai/grok-4.6', label: 'Grok 4.6', contextWindow: 200000, tags: ['reasoning', 'fast'] },
    { id: 'x-ai/grok-4.5', label: 'Grok 4.5', contextWindow: 200000, tags: ['reasoning'] },
    { id: 'deepseek/deepseek-v4.1-flash', label: 'DeepSeek V4.1 Flash', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'deepseek/deepseek-v4-pro-0813', label: 'DeepSeek V4 Pro', contextWindow: 128000, tags: ['reasoning', 'code'] },
    { id: 'deepseek/deepseek-r1-0528', label: 'DeepSeek R1 (0528)', contextWindow: 128000, tags: ['reasoning', 'code'] },
    { id: 'moonshotai/kimi-k3', label: 'Kimi K3 (Moonshot)', contextWindow: 256000, tags: ['reasoning', 'code'] },
    { id: 'qwen/qwen3.8-max-0902', label: 'Qwen 3.8 Max', contextWindow: 128000, tags: ['reasoning', 'code'] },
    { id: 'mistralai/mistral-large', label: 'Mistral Large', contextWindow: 128000, tags: ['reasoning', 'code'] },
    { id: 'mistralai/mistral-medium-3', label: 'Mistral Medium 3', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'meta-llama/llama-4-maverick', label: 'Llama 4 Maverick', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'minimax/minimax-m2', label: 'MiniMax M2', contextWindow: 200000, tags: ['reasoning'] },
    // Verified free tier (checked against the live OpenRouter catalog)
    { id: 'nvidia/nemotron-3-ultra-550b-a55b:free', label: 'Nemotron 3 Ultra 550B (Free)', contextWindow: 128000, tags: ['free', 'reasoning'], isFree: true },
    { id: 'nvidia/nemotron-3-super-120b-a12b:free', label: 'Nemotron 3 Super 120B (Free)', contextWindow: 128000, tags: ['free', 'fast'], isFree: true },
    { id: 'z-ai/glm-5.2:free', label: 'GLM 5.2 (Free)', contextWindow: 128000, tags: ['free', 'code'], isFree: true },
    { id: 'google/gemma-4-31b-it:free', label: 'Gemma 4 31B (Free)', contextWindow: 128000, tags: ['free', 'fast'], isFree: true },
    { id: 'google/gemma-4-26b-a4b-it:free', label: 'Gemma 4 26B A4B (Free)', contextWindow: 128000, tags: ['free', 'fast'], isFree: true },
    { id: 'thinkingmachines/inkling:free', label: 'Inkling (Free Reasoning)', contextWindow: 128000, tags: ['free', 'reasoning'], isFree: true },
    { id: 'thinkingmachines/inkling-small:free', label: 'Inkling Small (Free)', contextWindow: 128000, tags: ['free', 'fast'], isFree: true },
    { id: 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free', label: 'Nemotron 3 Nano Omni (Free)', contextWindow: 128000, tags: ['free', 'reasoning'], isFree: true },
    { id: 'poolside/laguna-s-2.1:free', label: 'Laguna S 2.1 (Free Code)', contextWindow: 128000, tags: ['free', 'code'], isFree: true },
    { id: 'cohere/north-mini-code:free', label: 'North Mini Code (Free)', contextWindow: 128000, tags: ['free', 'code'], isFree: true },
    { id: 'openrouter/free', label: 'OpenRouter Free Auto-Router', contextWindow: 32000, tags: ['free', 'fast'], isFree: true },
  ],
...
export const deepinfraProvider: IModelProvider = {
  id: 'deepinfra',
  name: 'DeepInfra',
  description: 'Scalable cost-effective open-weights inference (DeepSeek V4, Kimi K3, GLM 5.3, Qwen 3.8)',
  requiresApiKey: true,
  apiKeyField: 'deepinfraApiKey',
  docsUrl: 'https://deepinfra.com',
  models: [
    { id: 'deepseek-ai/DeepSeek-V4-Pro', label: 'DeepSeek V4 Pro (Frontier Reasoning)', contextWindow: 128000, tags: ['reasoning', 'code'] },
    { id: 'deepseek-ai/DeepSeek-V4-Flash-0731', label: 'DeepSeek V4 Flash (Fast Reasoning)', contextWindow: 128000, tags: ['fast', 'reasoning'] },
    { id: 'deepseek-ai/DeepSeek-V3.2', label: 'DeepSeek V3.2', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'deepseek-ai/DeepSeek-R1-0528', label: 'DeepSeek R1 (0528)', contextWindow: 128000, tags: ['reasoning'] },
    { id: 'moonshotai/Kimi-K3', label: 'Kimi K3 (Moonshot)', contextWindow: 256000, tags: ['reasoning', 'code'] },
    { id: 'moonshotai/Kimi-K2.6', label: 'Kimi K2.6', contextWindow: 256000, tags: ['reasoning', 'fast'] },
    { id: 'zai-org/GLM-5.3', label: 'GLM 5.3 (Code & Reasoning)', contextWindow: 200000, tags: ['reasoning', 'code'] },
    { id: 'zai-org/GLM-5.3-Flash', label: 'GLM 5.3 Flash (Fast Code)', contextWindow: 200000, tags: ['fast', 'code'] },
    { id: 'Qwen/Qwen3.8-Max', label: 'Qwen 3.8 Max', contextWindow: 128000, tags: ['reasoning', 'code'] },
    { id: 'Qwen/Qwen3.8-Flash', label: 'Qwen 3.8 Flash (Fast)', contextWindow: 128000, tags: ['fast'] },
    { id: 'Qwen/Qwen3-Next-80B-A3B-Instruct', label: 'Qwen 3 Next 80B A3B', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'meta-llama/Llama-4-Scout-17B-16E-Instruct', label: 'Llama 4 Scout 17B', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'meta-llama/Llama-3.3-70B-Instruct-Turbo', label: 'Llama 3.3 70B Turbo', contextWindow: 128000, tags: ['fast', 'code'] },
    { id: 'mistralai/Mistral-Small-3.2-24B-Instruct-2506', label: 'Mistral Small 3.2 24B', contextWindow: 128000, tags: ['fast', 'code'] },
